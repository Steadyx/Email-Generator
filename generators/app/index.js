...
module.exports = Generator.extend({
  prompting: function () {
    ...
    this.log(yosay('Welcome to the ' + chalk.red('generator-email') + ' generator!'));
  ...
  config: function () {
    ...
    this
      .fs
      .copyTpl(this.templatePath('_package.json'), this.destinationPath('package.json'), {name: this.props.name});
    this
      .fs
  ...
  app: function () {
    this
      .fs
      .copyTpl(this.templatePath('_index.js'), this.destinationPath('index.js'));
    this
      .fs
      .copyTpl(this.templatePath('_gulpfile.js'), this.destinationPath('gulpfile.js'));
